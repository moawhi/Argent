...
export const APP_DESCRIPTION =
  "Import an OpenAPI spec, pick the endpoints agents may call, and get a hosted MCP URL for Cursor and Claude — credentials never leave the gateway. Sites come along for free.";
